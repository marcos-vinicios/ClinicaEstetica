...
public class SegundaActivity extends AppCompatActivity {
        ...
        btUm.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (notaUm != null){
                    ...
                    databaseReference.child("Nota2").child("1").child(n.getId()).setValue(n);
                    startActivity(new Intent(SegundaActivity.this, TerceiraActivity.class));
                    finish();
                }
        ...
        btDois.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (notaDois != null){
                    ...
                    databaseReference.child("Nota2").child("2").child(n.getId()).setValue(n);
                    startActivity(new Intent(SegundaActivity.this,TerceiraActivity.class));
                    finish();
                }
        ...
        btTres.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (notaTres != null){
                    ...
                    databaseReference.child("Nota2").child("3").child(n.getId()).setValue(n);
                    startActivity(new Intent(SegundaActivity.this,TerceiraActivity.class));
                    finish();
                }
        ...
        btQuatro.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (notaQuatro != null){
                    ...
                    databaseReference.child("Nota2").child("4").child(n.getId()).setValue(n);
                    startActivity(new Intent(SegundaActivity.this,TerceiraActivity.class));
                    finish();
                }
        ...
        btCinco.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (notaCinco != null){
                    ...
                    databaseReference.child("Nota2").child("5").child(n.getId()).setValue(n);
                    startActivity(new Intent(SegundaActivity.this,TerceiraActivity.class));
                }
    ...
    private void inicializarFirebase(){
        FirebaseApp.initializeApp(SegundaActivity.this);
