...
public class QuartaActivity extends AppCompatActivity {
        ...
        btUm.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (notaUm != null){
                    ...
                    databaseReference.child("Nota4").child("1").child(n.getId()).setValue(n);
                    startActivity(new Intent(QuartaActivity.this,SugestaoActivity.class));
                    finish();
                }
        ...
        btDois.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (notaDois != null){
                    ...
                    databaseReference.child("Nota4").child("2").child(n.getId()).setValue(n);
                    startActivity(new Intent(QuartaActivity.this,SugestaoActivity.class));
                    finish();
                }
            }
        ...
        btTres.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (notaTres != null){
                    ...
                    databaseReference.child("Nota4").child("3").child(n.getId()).setValue(n);
                    startActivity(new Intent(QuartaActivity.this,SugestaoActivity.class));
                    finish();
                }
            }
        ...
        btQuatro.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(notaQuatro != null){
                    ...
                    databaseReference.child("Nota4").child("4").child(n.getId()).setValue(n);
                    startActivity(new Intent(QuartaActivity.this,SugestaoActivity.class));
                    finish();
                }
            }
        ...
        btCinco.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (notaCinco != null){
                    ...
                    databaseReference.child("Nota4").child("5").child(n.getId()).setValue(n);
                    startActivity(new Intent(QuartaActivity.this,SugestaoActivity.class));
                    finish();
                }
            }
    ...
    private void inicializarFirebase(){
        FirebaseApp.initializeApp(QuartaActivity.this);
